...
Public Class Form1
    Private filePath As String = "FORMPRESET.txt"
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        FormControlsPresetSystem.LoadControlValues(Me, filePath)
    End Sub

    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        FormControlsPresetSystem.SaveControlValues(Me, filePath)
        Close()
    End Sub
...
Public Class FormControlsPresetSystem
